...
const Footer = () => {
    return (
        <footer className='flex flex-col p-6 gap-6 items-center bg-black text-white'>
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2 container">
                <div className="flex flex-col gap-4 items-center">
                    <Image src={'/logo.svg'} width={100} height={100} objectFit="contain" alt="Logo" />
                    <div className="text-gray-400 text-sm ">
                        ...
                        <div className="flex items-center gap-2 hover:text-accent">
                            ...
                            <a className='transition-colors' href='mailto:contact@bevarc.com'>contact@bevarc.com</a>
                        </div>
                        <div className="flex gap-2 items-center hover:text-accent">
                            <Phone className='w-4 h-4 shrink-0 transition-colors' />
                            <a className='transition-colors' href='tel:+918207523052'>+91 8207523052</a>
                        </div>
                        <div className="flex gap-2 items-center hover:text-accent">
                            <Phone className='w-4 h-4 shrink-0 transition-colors' />
                            <a className='transition-colors' href='tel:+9608524728'>+91 9608524728</a>
                        </div>
                    </div>
                </div>
